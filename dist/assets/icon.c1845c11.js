import{aJ as l,cE as h,cF as e,cG as o,cH as n,cI as p,cJ as m,cK as f,cL as t,cM as d,cN as F,cO as v,cP as E,cQ as u,cR as M,cS as H,cT as I}from"./index.4fcb4360.js";import{m as B,n as V,p as A,q as k}from"./index.4743bdc5.js";import{I as x}from"./Layout.2edf1849.js";import{a as L}from"./index.dd7d36a9.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function D(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function Z(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}function O(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":F,"exe,msi":v,apk:x,db:B,md:E,epub:V,iso:A,m3u8:t,"doc,docx":u,"xls,xlsx":M,"ppt,pptx":H,pdf:I,psd:D,ai:Z,url:k,cast:L},S=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(i.toLowerCase()))return r;if(e().includes(i))return o}switch(a){case c.FOLDER:return d;case c.VIDEO:return t;case c.AUDIO:return f;case c.TEXT:return m;case c.IMAGE:return p;default:return n}},R=a=>S(a.type,h(a.name));export{O as A,c as O,R as g};
